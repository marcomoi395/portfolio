...
2. Create `content/pages/blog.md` and set its yaml parameters to
...
3. Change `content/pages/about.md` yaml parameters to following
...
4. In `content/pages/home.md` add
...
5. Create `content/pages/categories.md` with following yaml parameters
```yaml
layout: categories
...
6. In the `_config.yml` file add following and change accordingly
...
- `content/pages/home.md` — home hero text
- `content/pages/about.md` — about page content
- `content/pages/blog.md` — blog page config
- `content/pages/categories.md` — categories page config
...
## Writing a new blog
Create a new folder `content/_posts` in root folder if not already exists.
